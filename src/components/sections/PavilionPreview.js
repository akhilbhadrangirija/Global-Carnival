...
export function PavilionPreview() {
            ...
            >
              <Card className="h-full overflow-hidden hover:shadow-xl transition-all duration-300 group bg-white">
                <div className="relative h-80 overflow-hidden">
                  <Image
                    src={pavilion.image}
                    alt={`${pavilion.name} pavilion at Global Carnival Jeddah`}
                    fill
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-4">
                    ...
                    <div className="flex gap-2 mb-4">
                      <div className="flex items-center gap-1 px-3 py-1 backdrop-blur-sm border border-gray-100 rounded-full">
                        ...
                        <span className="text-white text-xs font-medium">{pavilion.tag}</span>
                      </div>
                      <div className="flex items-center gap-1 px-3 py-1 backdrop-blur-sm border border-gray-100 rounded-full">
                        <Clock className="w-3 h-3 text-white" />
                        <span className="text-white text-xs font-medium">{pavilion.duration}</span>
                      </div>
                    </div>
                    
                    {/* Call to Action Button */}
                    <Link href={pavilion.href} className="block">
